...
export async function GET() {
  const roadmaps = [
    {
      ...
      title: 'Estudar Rust',
      description:
        'Recentemente eu tenho estudado Rust ocasionalmente, e estou gostando bastante da linguagem. Acredito que ela tem um potencial enorme, e que pode ser uma das linguagens mais usadas no futuro. Por isso, estou estudando ela para me preparar para o futuro e para o que está por vir.',
      badges: ['Rust', 'Study'],
    },
    {
      id: 'comakit',
  ...
  return NextResponse.json(roadmaps as Roadmap[])
}
